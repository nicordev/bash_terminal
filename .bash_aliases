...
alias please_git_reset_to_commit='git_reset_to_commit.sh'
...
alias please_linux_find='find_name.sh'
alias please_linux_rmrf='sudo rm -rf'
alias please_linux_copy_all='cp -r'
alias please_linux_remove='please_rmrf'
alias please_linux_show_aliases='alias -p | sort'
alias please_linux_upgrade_packages='upgrade_packages.sh'
alias please_linux_change_folder_owner_and_its_content='sudo chown -R'
alias please_linux_change_file_or_folder_owner='sudo chown'
alias please_linux_change_file_or_folder_group='sudo chgrp'
alias please_linux_add_group_to_user='sudo usermod -aG'
alias please_linux_display_listening_ports='sudo lsof -i -P -n | grep LISTEN'
alias please_linux_how_to_show_the_current_distribution='echo -e "cat /etc/os-release"'
alias please_linux_what_is_the_current_distribution='cat /etc/os-release'
alias please_linux_how_to_unmount_usb_key='echo -e "umount \e[33mcheminVers/CléUsb\e[0m"'
alias please_linux_how_to_format_usb_key='echo -e "sudo mkfs.vfat -n \e[33mNOUVEAU_NOM_CLE_USB\e[0m -I \e[33m/dev/sdb\e[0m"'
alias please_linux_how_to_create_bootable_usb_key='echo -e "\e[34mFirst unmount the key, format the key then\e[0m" && echo -e "sudo dd bs=4M if=\e[33mcheminVers/FichierImage.iso\e[0m of=\e[33m/dev/sdb status=progress\e[0m"'
alias please_linux_how_to_list_disks='echo -e "df" && echo -e "\e[34mor\e[0m" && echo -e "sudo fdisk -l" && echo -e "\e[34mor\e[0m" && echo -e "lsblk"'
